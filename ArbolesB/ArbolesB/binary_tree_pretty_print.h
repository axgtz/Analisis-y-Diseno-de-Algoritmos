...
void printBranches(int branchLen, int nodeSpaceLen, int startLen, int nodesInThisLevel, const deque<TreeNode<int>*>& nodesQueue, ostream& out) {
  deque<TreeNode<int>*>::const_iterator iter = nodesQueue.begin();
...
void printNodes(int branchLen, int nodeSpaceLen, int startLen, int nodesInThisLevel, const deque<TreeNode<int>*>& nodesQueue, ostream& out) {
  deque<TreeNode<int>*>::const_iterator iter = nodesQueue.begin();
...
void printLeaves(int indentSpace, int level, int nodesInThisLevel, const deque<TreeNode<int>*>& nodesQueue, ostream& out) {
  deque<TreeNode<int>*>::const_iterator iter = nodesQueue.begin();
  for (int i = 0; i < nodesInThisLevel; i++, iter++) {
...
void printPretty(TreeNode<int> *root, int level, int indentSpace, ostream& out) {
  ...
  for (int r = 1; r < h; r++) {
    ...
    for (int i = 0; i < nodesInThisLevel; i++) {
      TreeNode<int> *currNode = nodesQueue.front();

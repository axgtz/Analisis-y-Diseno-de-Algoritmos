...
\subsection{GraphML}
GraphML es un formato para almacenar datos basado en XML, y soporta menos información adicional que sus rivales, esto ayuda en su facilidad de exportar pero no se pueden incluir grafos complejos.
